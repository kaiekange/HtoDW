...
int sel_eff(){
    ...
    std::vector<double> *match_dxy_Kp_Km = nullptr;
    std::vector<double> *match_dxy_Kp_pi = nullptr;
    std::vector<double> *match_dxy_Km_pi = nullptr;
    std::vector<double> *match_dxy_Kp_phi = nullptr;
    std::vector<double> *match_dxy_Km_phi = nullptr;
    std::vector<double> *match_dxy_pi_phi = nullptr;
    std::vector<double> *match_dxy_Kp_Ds = nullptr;
    std::vector<double> *match_dxy_Km_Ds = nullptr;
    std::vector<double> *match_dxy_pi_Ds = nullptr;
    std::vector<double> *match_dxy_phi_Ds = nullptr;

    std::vector<double> *match_dz_Kp_Km = nullptr;
    std::vector<double> *match_dz_Kp_pi = nullptr;
    std::vector<double> *match_dz_Km_pi = nullptr;
    std::vector<double> *match_dz_Kp_phi = nullptr;
    std::vector<double> *match_dz_Km_phi = nullptr;
    std::vector<double> *match_dz_pi_phi = nullptr;
    std::vector<double> *match_dz_Kp_Ds = nullptr;
    std::vector<double> *match_dz_Km_Ds = nullptr;
    std::vector<double> *match_dz_pi_Ds = nullptr;
    std::vector<double> *match_dz_phi_Ds = nullptr;
    ...
    mychain->SetBranchAddress("match_dxy_Kp_Km", &match_dxy_Kp_Km);
    mychain->SetBranchAddress("match_dxy_Kp_pi", &match_dxy_Kp_pi);
    mychain->SetBranchAddress("match_dxy_Km_pi", &match_dxy_Km_pi);
    mychain->SetBranchAddress("match_dxy_Kp_phi", &match_dxy_Kp_phi);
    mychain->SetBranchAddress("match_dxy_Km_phi", &match_dxy_Km_phi);
    mychain->SetBranchAddress("match_dxy_pi_phi", &match_dxy_pi_phi);
    mychain->SetBranchAddress("match_dxy_Kp_Ds", &match_dxy_Kp_Ds);
    mychain->SetBranchAddress("match_dxy_Km_Ds", &match_dxy_Km_Ds);
    mychain->SetBranchAddress("match_dxy_pi_Ds", &match_dxy_pi_Ds);
    mychain->SetBranchAddress("match_dxy_phi_Ds", &match_dxy_phi_Ds);

    mychain->SetBranchAddress("match_dz_Kp_Km", &match_dz_Kp_Km);
    mychain->SetBranchAddress("match_dz_Kp_pi", &match_dz_Kp_pi);
    mychain->SetBranchAddress("match_dz_Km_pi", &match_dz_Km_pi);
    mychain->SetBranchAddress("match_dz_Kp_phi", &match_dz_Kp_phi);
    mychain->SetBranchAddress("match_dz_Km_phi", &match_dz_Km_phi);
    mychain->SetBranchAddress("match_dz_pi_phi", &match_dz_pi_phi);
    mychain->SetBranchAddress("match_dz_Kp_Ds", &match_dz_Kp_Ds);
    mychain->SetBranchAddress("match_dz_Km_Ds", &match_dz_Km_Ds);
    mychain->SetBranchAddress("match_dz_pi_Ds", &match_dz_pi_Ds);
    mychain->SetBranchAddress("match_dz_phi_Ds", &match_dz_phi_Ds);
    ...
    for(int i=0; i<nevents; i++){
        ...
        if( match_dR_Kp_Km->at(0) > 0.15) continue; n_dR_Kp_Km++;
        if( match_dR_Kp_pi->at(0) > 0.6) continue; n_dR_Kp_pi++;
        if( match_dR_Km_pi->at(0) > 0.6) continue; n_dR_Km_pi++;
        if( match_phiFit_dR_pi_phi->at(0) > 1 ) continue; n_phiFit_dR_pi_phi++;
        if( match_DsFit_dR_phi_Ds->at(0) > 0.4 ) continue; n_DsFit_dR_phi_Ds++;
        
        if( match_dxy_Kp_Km->at(0) > 0.2) continue; n_dxy_Kp_Km++;
        if( match_dz_Kp_Km->at(0) > 0.2) continue; n_dz_Kp_Km++;

        if( match_dxy_Kp_pi->at(0) > 0.4 ) continue; n_dxy_Kp_pi++;
        if( match_dz_Kp_pi->at(0) > 0.4 ) continue; n_dz_Kp_pi++;

        if( match_dxy_Km_pi->at(0) > 0.4 ) continue; n_dxy_Km_pi++;
        if( match_dz_Km_pi->at(0) > 0.4 ) continue; n_dz_Km_pi++;
        
        if( match_dxy_pi_phi->at(0) > 6 ) continue; n_dxy_pi_phi++;
        if( match_dz_pi_phi->at(0) > 6 ) continue; n_dz_pi_phi++;
        
        if( match_dxy_phi_Ds->at(0) > 4 ) continue; n_dxy_phi_Ds++;
        if( match_dz_phi_Ds->at(0) > 4 ) continue; n_dz_phi_Ds++;
    ...
    std::cout << "n_dxy_Kp_Km " << n_dxy_Kp_Km << std::endl;
    std::cout << "n_dz_Kp_Km " << n_dz_Kp_Km << std::endl;
    std::cout << "n_dxy_Kp_pi " << n_dxy_Kp_pi << std::endl;
    std::cout << "n_dz_Kp_pi " << n_dz_Kp_pi << std::endl;
    std::cout << "n_dxy_Km_pi " << n_dxy_Km_pi << std::endl;
    std::cout << "n_dz_Km_pi " << n_dz_Km_pi << std::endl;
    std::cout << "n_dxy_pi_phi " << n_dxy_pi_phi << std::endl;
    std::cout << "n_dz_pi_phi " << n_dz_pi_phi << std::endl;
    std::cout << "n_dxy_phi_Ds " << n_dxy_phi_Ds << std::endl;
    std::cout << "n_dz_phi_Ds " << n_dz_phi_Ds << std::endl;
