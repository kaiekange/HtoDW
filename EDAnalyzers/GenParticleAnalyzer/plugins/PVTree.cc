...
void PVTree::Init()
{
    ...
    Gen_mu_ETA_vec.clear();
    Gen_mu_PHI_vec.clear();
    Gen_mu_ORIVX_X_vec.clear();
    Gen_mu_ORIVX_Y_vec.clear();
    Gen_mu_ORIVX_Z_vec.clear();
    Gen_mu_P_vec.clear();
    Gen_mu_PT_vec.clear();
    Gen_mu_PX_vec.clear();
    Gen_mu_PY_vec.clear();
    ...
    Gen_nu_ETA_vec.clear();
    Gen_nu_PHI_vec.clear();
    Gen_nu_ORIVX_X_vec.clear();
    Gen_nu_ORIVX_Y_vec.clear();
    Gen_nu_ORIVX_Z_vec.clear();
    Gen_nu_P_vec.clear();
    Gen_nu_PT_vec.clear();
    Gen_nu_PX_vec.clear();
    Gen_nu_PY_vec.clear();
    ...
    Gen_W_ETA_vec.clear();
    Gen_W_PHI_vec.clear();
    Gen_W_ORIVX_X_vec.clear();
    Gen_W_ORIVX_Y_vec.clear();
    Gen_W_ORIVX_Z_vec.clear();
    Gen_W_P_vec.clear();
    Gen_W_PT_vec.clear();
    Gen_W_PX_vec.clear();
    Gen_W_PY_vec.clear();
    ...
    Gen_H_ETA_vec.clear();
    Gen_H_PHI_vec.clear();
    Gen_H_ORIVX_X_vec.clear();
    Gen_H_ORIVX_Y_vec.clear();
    Gen_H_ORIVX_Z_vec.clear();
    Gen_H_P_vec.clear();
    Gen_H_PT_vec.clear();
    Gen_H_PX_vec.clear();
    Gen_H_PY_vec.clear();
    ...
    match_PV_CHI2_vec.clear();
    match_PV_NDOF_vec.clear();
    match_PV_CHI2NDOF_vec.clear();
    match_PV_X_vec.clear();
    match_PV_Y_vec.clear();
    match_PV_Z_vec.clear();
    match_PV_XERR_vec.clear();
    match_PV_YERR_vec.clear();
    match_PV_ZERR_vec.clear();
    ...
    best_PV_CHI2_vec.clear();
    best_PV_NDOF_vec.clear();
    best_PV_CHI2NDOF_vec.clear();
    best_PV_X_vec.clear();
    best_PV_Y_vec.clear();
    best_PV_Z_vec.clear();
    best_PV_XERR_vec.clear();
    best_PV_YERR_vec.clear();
    best_PV_ZERR_vec.clear();
}

void PVTree::Gen_Fill_Vector()
{
    ...
    Gen_mu_ETA_vec.push_back(Gen_mu_ETA);
    Gen_mu_PHI_vec.push_back(Gen_mu_PHI);
    Gen_mu_ORIVX_X_vec.push_back(Gen_mu_ORIVX_X);
    Gen_mu_ORIVX_Y_vec.push_back(Gen_mu_ORIVX_Y);
    Gen_mu_ORIVX_Z_vec.push_back(Gen_mu_ORIVX_Z);
    Gen_mu_P_vec.push_back(Gen_mu_P);
    Gen_mu_PT_vec.push_back(Gen_mu_PT);
    Gen_mu_PX_vec.push_back(Gen_mu_PX);
    Gen_mu_PY_vec.push_back(Gen_mu_PY);
    Gen_mu_PZ_vec.push_back(Gen_mu_PZ);

    Gen_nu_ETA_vec.push_back(Gen_nu_ETA);
    Gen_nu_PHI_vec.push_back(Gen_nu_PHI);
    Gen_nu_ORIVX_X_vec.push_back(Gen_nu_ORIVX_X);
    Gen_nu_ORIVX_Y_vec.push_back(Gen_nu_ORIVX_Y);
    Gen_nu_ORIVX_Z_vec.push_back(Gen_nu_ORIVX_Z);
    Gen_nu_P_vec.push_back(Gen_nu_P);
    Gen_nu_PT_vec.push_back(Gen_nu_PT);
    Gen_nu_PX_vec.push_back(Gen_nu_PX);
    Gen_nu_PY_vec.push_back(Gen_nu_PY);
    Gen_nu_PZ_vec.push_back(Gen_nu_PZ);

    Gen_W_ETA_vec.push_back(Gen_W_ETA);
    Gen_W_PHI_vec.push_back(Gen_W_PHI);
    Gen_W_ORIVX_X_vec.push_back(Gen_W_ORIVX_X);
    Gen_W_ORIVX_Y_vec.push_back(Gen_W_ORIVX_Y);
    Gen_W_ORIVX_Z_vec.push_back(Gen_W_ORIVX_Z);
    Gen_W_P_vec.push_back(Gen_W_P);
    Gen_W_PT_vec.push_back(Gen_W_PT);
    Gen_W_PX_vec.push_back(Gen_W_PX);
    Gen_W_PY_vec.push_back(Gen_W_PY);
    Gen_W_PZ_vec.push_back(Gen_W_PZ);

    Gen_H_ETA_vec.push_back(Gen_H_ETA);
    Gen_H_PHI_vec.push_back(Gen_H_PHI);
    Gen_H_ORIVX_X_vec.push_back(Gen_H_ORIVX_X);
    Gen_H_ORIVX_Y_vec.push_back(Gen_H_ORIVX_Y);
    Gen_H_ORIVX_Z_vec.push_back(Gen_H_ORIVX_Z);
    Gen_H_P_vec.push_back(Gen_H_P);
    Gen_H_PT_vec.push_back(Gen_H_PT);
    Gen_H_PX_vec.push_back(Gen_H_PX);
    Gen_H_PY_vec.push_back(Gen_H_PY);
    Gen_H_PZ_vec.push_back(Gen_H_PZ);
...
void PVTree::Match_Fill_PV()
{
    match_PV_CHI2_vec.push_back(match_PV_CHI2);
    match_PV_NDOF_vec.push_back(match_PV_NDOF);
    match_PV_CHI2NDOF_vec.push_back(match_PV_CHI2NDOF);
    match_PV_X_vec.push_back(match_PV_X);
    match_PV_Y_vec.push_back(match_PV_Y);
    match_PV_Z_vec.push_back(match_PV_Z);
    match_PV_XERR_vec.push_back(match_PV_XERR);
    match_PV_YERR_vec.push_back(match_PV_YERR);
    match_PV_ZERR_vec.push_back(match_PV_ZERR);
}
...
void PVTree::Best_Fill_Vector(int idxmax)
{
    ...
    best_PV_CHI2_vec.push_back(PV_CHI2_vec[idxmax]);
    best_PV_NDOF_vec.push_back(PV_NDOF_vec[idxmax]);
    best_PV_CHI2NDOF_vec.push_back(PV_CHI2NDOF_vec[idxmax]);
    best_PV_X_vec.push_back(PV_X_vec[idxmax]);
    best_PV_Y_vec.push_back(PV_Y_vec[idxmax]);
    best_PV_Z_vec.push_back(PV_Z_vec[idxmax]);
    best_PV_XERR_vec.push_back(PV_XERR_vec[idxmax]);
    best_PV_YERR_vec.push_back(PV_YERR_vec[idxmax]);
    best_PV_ZERR_vec.push_back(PV_ZERR_vec[idxmax]);
}
...
void PVTree::Fill_PV()
{
    PV_CHI2_vec.push_back(PV_CHI2);
    PV_NDOF_vec.push_back(PV_NDOF);
    PV_CHI2NDOF_vec.push_back(PV_CHI2NDOF);
    PV_X_vec.push_back(PV_X);
    PV_Y_vec.push_back(PV_Y);
    PV_Z_vec.push_back(PV_Z);
    PV_XERR_vec.push_back(PV_XERR);
    PV_YERR_vec.push_back(PV_YERR);
    PV_ZERR_vec.push_back(PV_ZERR);
}
...
void PVTree::CreateBranches()
{
    ...
    tree->Branch("Gen_mu_ETA", &Gen_mu_ETA_vec);
    tree->Branch("Gen_mu_PHI", &Gen_mu_PHI_vec);
    tree->Branch("Gen_mu_ORIVX_X", &Gen_mu_ORIVX_X_vec);
    tree->Branch("Gen_mu_ORIVX_Y", &Gen_mu_ORIVX_Y_vec);
    tree->Branch("Gen_mu_ORIVX_Z", &Gen_mu_ORIVX_Z_vec);
    tree->Branch("Gen_mu_P", &Gen_mu_P_vec);
    tree->Branch("Gen_mu_PT", &Gen_mu_PT_vec);
    tree->Branch("Gen_mu_PX", &Gen_mu_PX_vec);
    tree->Branch("Gen_mu_PY", &Gen_mu_PY_vec);
    tree->Branch("Gen_mu_PZ", &Gen_mu_PZ_vec);

    tree->Branch("Gen_nu_ETA", &Gen_nu_ETA_vec);
    tree->Branch("Gen_nu_PHI", &Gen_nu_PHI_vec);
    tree->Branch("Gen_nu_ORIVX_X", &Gen_nu_ORIVX_X_vec);
    tree->Branch("Gen_nu_ORIVX_Y", &Gen_nu_ORIVX_Y_vec);
    tree->Branch("Gen_nu_ORIVX_Z", &Gen_nu_ORIVX_Z_vec);
    tree->Branch("Gen_nu_P", &Gen_nu_P_vec);
    tree->Branch("Gen_nu_PT", &Gen_nu_PT_vec);
    tree->Branch("Gen_nu_PX", &Gen_nu_PX_vec);
    tree->Branch("Gen_nu_PY", &Gen_nu_PY_vec);
    tree->Branch("Gen_nu_PZ", &Gen_nu_PZ_vec);

    tree->Branch("Gen_W_ETA", &Gen_W_ETA_vec);
    tree->Branch("Gen_W_PHI", &Gen_W_PHI_vec);
    tree->Branch("Gen_W_ORIVX_X", &Gen_W_ORIVX_X_vec);
    tree->Branch("Gen_W_ORIVX_Y", &Gen_W_ORIVX_Y_vec);
    tree->Branch("Gen_W_ORIVX_Z", &Gen_W_ORIVX_Z_vec);
    tree->Branch("Gen_W_P", &Gen_W_P_vec);
    tree->Branch("Gen_W_PT", &Gen_W_PT_vec);
    tree->Branch("Gen_W_PX", &Gen_W_PX_vec);
    tree->Branch("Gen_W_PY", &Gen_W_PY_vec);
    tree->Branch("Gen_W_PZ", &Gen_W_PZ_vec);

    tree->Branch("Gen_H_ETA", &Gen_H_ETA_vec);
    tree->Branch("Gen_H_PHI", &Gen_H_PHI_vec);
    tree->Branch("Gen_H_ORIVX_X", &Gen_H_ORIVX_X_vec);
    tree->Branch("Gen_H_ORIVX_Y", &Gen_H_ORIVX_Y_vec);
    tree->Branch("Gen_H_ORIVX_Z", &Gen_H_ORIVX_Z_vec);
    tree->Branch("Gen_H_P", &Gen_H_P_vec);
    tree->Branch("Gen_H_PT", &Gen_H_PT_vec);
    tree->Branch("Gen_H_PX", &Gen_H_PX_vec);
    tree->Branch("Gen_H_PY", &Gen_H_PY_vec);
    tree->Branch("Gen_H_PZ", &Gen_H_PZ_vec);
    ...
    tree->Branch("match_PV_CHI2", &match_PV_CHI2_vec);
    tree->Branch("match_PV_NDOF", &match_PV_NDOF_vec);
    tree->Branch("match_PV_CHI2NDOF", &match_PV_CHI2NDOF_vec);
    tree->Branch("match_PV_X", &match_PV_X_vec);
    tree->Branch("match_PV_Y", &match_PV_Y_vec);
    tree->Branch("match_PV_Z", &match_PV_Z_vec);
    tree->Branch("match_PV_XERR", &match_PV_XERR_vec);
    tree->Branch("match_PV_YERR", &match_PV_YERR_vec);
    tree->Branch("match_PV_ZERR", &match_PV_ZERR_vec);
    ...
    tree->Branch("PV_CHI2", &PV_CHI2_vec);
    tree->Branch("PV_NDOF", &PV_NDOF_vec);
    tree->Branch("PV_CHI2NDOF", &PV_CHI2NDOF_vec);
    tree->Branch("PV_X", &PV_X_vec);
    tree->Branch("PV_Y", &PV_Y_vec);
    tree->Branch("PV_Z", &PV_Z_vec);
    tree->Branch("PV_XERR", &PV_XERR_vec);
    tree->Branch("PV_YERR", &PV_YERR_vec);
    tree->Branch("PV_ZERR", &PV_ZERR_vec);
    ...
    tree->Branch("best_PV_CHI2", &best_PV_CHI2_vec);
    tree->Branch("best_PV_NDOF", &best_PV_NDOF_vec);
    tree->Branch("best_PV_CHI2NDOF", &best_PV_CHI2NDOF_vec);
    tree->Branch("best_PV_X", &best_PV_X_vec);
    tree->Branch("best_PV_Y", &best_PV_Y_vec);
    tree->Branch("best_PV_Z", &best_PV_Z_vec);
    tree->Branch("best_PV_XERR", &best_PV_XERR_vec);
    tree->Branch("best_PV_YERR", &best_PV_YERR_vec);
    tree->Branch("best_PV_ZERR", &best_PV_ZERR_vec);
}
