...
static constexpr auto s_tag = "[GenParticleAnalyzer]";

TEST_CASE("Standard checks of GenParticleAnalyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("GenParticleAnalyzer"
