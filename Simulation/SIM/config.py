...
# with command line options: --python_filename config_temp.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --filein file:infile --fileout file:outfile --conditions 106X_mc2017_realistic_v9 --beamspot Realistic25ns13TeVEarly2017Collision --step SIM --geometry DB:Extended --era Run2_2017 --no_exec --mc --nThreads=4 -n -1
import sys
