...
# with command line options: Configuration/GenProduction/python/gridpacktogen_ggHtoDsW_fragment_cff.py --python_filename LHEGEN_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-LHE --fileout file:output.root --conditions 106X_mc2017_realistic_v9 --beamspot Realistic25ns13TeVEarly2017Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step LHE,GEN --geometry DB:Extended --era Run2_2017 --no_exec --mc -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/gridpacktogen_ggHtoDsW_fragment_cff.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('GEN-LHE'),
