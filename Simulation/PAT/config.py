...
# with command line options: --python_filename config_temp.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --filein file:infile --fileout file:outfile --conditions 106X_mc2017_realistic_v9 --beamspot Realistic25ns13TeVEarly2017Collision --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --era Run2_2017 --runUnscheduled --no_exec --mc --nThreads=4 -n -1
import sys
