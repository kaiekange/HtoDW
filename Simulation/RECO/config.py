...
# with command line options: --python_filename config_temp.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --filein file:infile --fileout file:outfile --conditions 106X_mc2017_realistic_v9 --beamspot Realistic25ns13TeVEarly2017Collision --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --geometry DB:Extended --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --era Run2_2017 --no_exec --mc --nThreads=4 -n -1
import sys
